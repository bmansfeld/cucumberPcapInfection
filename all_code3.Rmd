...
<!-- GOres <- list() -->
<!-- k <- 1 -->
<!-- for (i in anovaModExp$moduleLabel) { -->
...
<!-- names(GOres) <- anovaModExp$moduleLabel -->
<!-- ``` -->

<!-- ```{r interactionModGO, fig.width=7, fig.height= 8} -->
<!-- fills <- rev(names(sort(table(moduleColors16.custom), decreasing = T))[anovaModExp$moduleLabel]) -->
...
<!--   geom_smooth(method = lm, -->
<!--               formula = y ~ splines::ns(x, df = 4), linetype = 2) + -->
<!--   facet_wrap(~ facetLabel, scales = "free", ncol = 1) + -->
...
<!-- ggpubr::ggarrange(gME, GO_ME, widths = c(1.2,1.5)) -->
<!-- ``` -->
