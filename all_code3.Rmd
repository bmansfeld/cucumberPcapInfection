...
# tidy_MEs16dpp <-
#   as_tibble(moduleEigengenes(infection16dpp, colors = moduleLabels16)$averageExpr) %>%
#   mutate(age = "16dpp",
#          timepoint = vst$timepoint[vst$treatment == "Inoc" &
#          vst$age == "16dpp"]) %>%
#          gather(key = "Module", value = "EigengeneExp", -age, -timepoint) %>%
#   bind_rows(.,
#             as_tibble(
#             moduleEigengenes(infection8dpp, colors = moduleLabels16)$averageExpr) %>%
#                 mutate(age = "8dpp",
#                 timepoint = vst$timepoint[vst$treatment == "Inoc" &
#                 vst$age == "8dpp"]) %>%
#                 gather(key = "Module", value = "EigengeneExp", -age, -timepoint)
#   ) %>%
#   mutate(numTP = as.numeric(str_remove(timepoint, "T")),
#          age = fct_relevel(age, "8dpp"),
#          moduleLabel = as.numeric(str_remove(Module, "AE")))

# tidy_MEs16dppCont <-
#   as_tibble(moduleEigengenes(control16dpp, colors = moduleLabels16)$averageExpr) %>%
#   mutate(age = "16dpp",
#          timepoint = vst$timepoint[vst$treatment == "Cont" &
#          vst$age == "16dpp"]) %>%
#          gather(key = "Module", value = "EigengeneExp", -age, -timepoint) %>%
#   bind_rows(.,
#             as_tibble(
#             moduleEigengenes(control8dpp, colors = moduleLabels16)$averageExpr) %>%
#                 mutate(age = "8dpp",
#                 timepoint = vst$timepoint[vst$treatment == "Cont" &
#                 vst$age == "8dpp"]) %>%
#                 gather(key = "Module", value = "EigengeneExp", -age, -timepoint),
